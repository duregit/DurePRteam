							...
							<div class="card card-primary">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-4">
											<div class="form-group row">
												<label for="suPiproperty" class="col-md-3 col-form-label">매장코드</label>
												<div class="col-md-9">
													<input type="text" class="form-control" id="suPiproperty" placeholder="매장코드">
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" id="suPipropname" placeholder="매장명">
												</div>
											</div>
										</div>
										<div class="col-md-3">
									...
									<table class="table table-bordered">
										...
										<tbody>
											<c:forEach var="CommonsSubProp" items="${ commonsSubProp }">
												<tr data-url="/admin/commonSubProp/edit?piProperty=${ commonsSubProp.piProperty }">
													<td>${ commonsSubProp.suPiproperty }</td>
													<td>${ commonsSubProp.suPipropname }</td>													
													<td>${ commonsSubProp.supiActive }</td>
													<td data-url="edit?piProperty=${ commonsSubProp.piProperty }">
